...
&nbsp;<a class="external-link" href="https://developer.mozilla.org/ko/docs/Web/CSS/Pseudo-classes">가상 선택자</a>는 가상 이벤트를 뜻하는데, :link, :visited, :focus 등 다양하다.
...
Cascading 규칙이 어렵고, 직관적이지 못하다면 <a class="external-link" href="https://specificity.keegan.st">해당 사이트</a>를 이용해보자.
